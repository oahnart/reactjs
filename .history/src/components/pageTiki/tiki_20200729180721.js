        ...
        <Col span={6} key={data.id}>
          <div className="img-body">
            {data.images.map((image) =>
                <img className="img-big" alt="oke" src="https://salt.tikicdn.com/cache/280x280/ts/product/5b/b2/c4/9574b9439edac59ab025881b9e62fc18.jpg" />
              )
            )}
          </div>
          <div className="img-style">
            {data.images.map((image) => (
              <div className="wp-img">
                <img className="image-small" alt="oke" src={image.url} />
              </div>
            ))}
          </div>
